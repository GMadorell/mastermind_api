...
def random_create_guess_command(guess_id: str = None,
                                game_id: str = None,
    ...
    first_code_peg = random_code_peg().peg_type if first_code_peg is None else first_code_peg
    second_code_peg = random_code_peg().peg_type if second_code_peg is None else second_code_peg
    third_code_peg = random_code_peg().peg_type if third_code_peg is None else third_code_peg
    fourth_code_peg = random_code_peg().peg_type if fourth_code_peg is None else fourth_code_peg
