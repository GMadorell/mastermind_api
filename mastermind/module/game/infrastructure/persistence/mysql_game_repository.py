...
class MySQLGameRepository(GameRepository):
    ...
    def insert(self, game: Game) -> None:
        self.database.query(
            ...
            INSERT INTO games
            (
                game_id, first_code_peg, second_code_peg,
    ...
    def search(self, game_id: GameId) -> Optional[Game]:
        ...
        if maybe_record is None:
            ...
            return Game(
                GameId(game_raw_data["game_id"]),
                CodePeg(game_raw_data["first_code_peg"]),
                CodePeg(game_raw_data["second_code_peg"]),
                CodePeg(game_raw_data["third_code_peg"]),
