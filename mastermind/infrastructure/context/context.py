...
from mastermind.module.game.application.search_game_use_case import SearchGameQueryHandler, SearchGameQuery
...
from mastermind.module.shared.infrastructure.bus.simple_query_bus import SimpleQueryBus
...
class Context:
    def __init__(self):
        ...
        self.search_game_query_handler = SearchGameQueryHandler(self.game_repository)
        ...
        self.create_guess_command_handler = \
            CreateGuessCommandHandler(GuessCreator(self.guess_repository, self.query_bus))
